            ...
            <div className="dash-widget">
              ...
              <div className="dash-widget-info text-right">
                ...
                <span className="widget-title1">
                  Doctors <i className="fa fa-check" aria-hidden="true" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="dash-widget">
              ...
              <div className="dash-widget-info text-right">
                ...
                <span className="widget-title2">
                  Patients <i className="fa fa-check" aria-hidden="true" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="dash-widget">
              ...
              <div className="dash-widget-info text-right">
                ...
                <span className="widget-title3">
                  Attend <i className="fa fa-check" aria-hidden="true" />
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="dash-widget">
              ...
              <div className="dash-widget-info text-right">
                ...
                <span className="widget-title4">
                  Pending <i className="fa fa-check" aria-hidden="true" />
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="card-body">
                <div className="chart-title">
                  ...
                  <span className="float-right">
                    <i className="fa fa-caret-up" aria-hidden="true" /> 15%
