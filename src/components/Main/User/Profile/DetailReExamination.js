...
const DetailReExamination = (props) => {
                                  ...
                                  <Col lg={9} md={9} sm={9} xs={6}>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        ></i>
                                        <div className="listService" style={{ position:"relative", marginLeft:"40px",marginTop:"-29px"}}>
                                          {newService.map(
...
DetailReExamination.propTypes = {};

export default DetailReExamination;
